          ...
          child: Padding(
            ...
            child: Column(
              ...
              Padding(
                ...
                child: Text('Vous avez obtenu \n\ un nouveau badge !',style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.normal, fontFamily: 'Gotham'), textAlign: TextAlign.center,),
              ),
              Padding(
              ...
              Text('Lorem Ipsum',style: TextStyle(color: myYellow, fontSize: 36, fontWeight: FontWeight.w900, fontFamily: 'Gotham'),),
             Spacer(flex: 1),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                   Text('Allez voir vos badges',style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.normal, fontFamily: 'Gotham'), textAlign: TextAlign.center,),
